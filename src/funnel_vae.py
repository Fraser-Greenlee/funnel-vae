...
from funnel_vae.src.vae import VAE
from funnel_vae.src.outputs import BaseTransformerVaeOutput
...
class FunnelVaeModel(PreTrainedModel):
    ...
    Parameters:
        config (:class:`~transformer_vae.FunnelVaeConfig`): Model configuration class with all the parameters of the model.
